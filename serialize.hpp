...
template<typename Stream, typename T>
static std::enable_if_t<is_reflection<T>::value> to_json(Stream& ss, T&& t);

template<typename Stream, typename T>
static std::enable_if_t<is_reflection<T>::value> render_json_value(Stream& ss, T&& t) {
...
template<typename Stream, typename T>
static std::enable_if_t <is_associat_container<T>::value>
